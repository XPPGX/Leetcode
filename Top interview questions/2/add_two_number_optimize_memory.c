...
struct ListNode* addTwoNumbers(struct ListNode* l1, struct ListNode* l2){
    ...
    int carry = 0;
    for(ptr1 = l1, ptr2 = l2; ptr1 != NULL && ptr2 != NULL; ptr1 = ptr1->next, ptr2 = ptr2->next){
    ...
    if(ptr1 == NULL && ptr2 != NULL){
        ...
        if(carry > 0){
            pre_ptr2->next = (struct ListNode*)malloc(sizeof(struct ListNode));
            pre_ptr2 = pre_ptr2->next;
            pre_ptr2->val = carry;
            pre_ptr2->next = NULL;
        }
    }
        ...
        if(carry > 0){
            pre_ptr1->next = (struct ListNode*)malloc(sizeof(struct ListNode));
